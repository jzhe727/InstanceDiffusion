...
import main_submitit as main_func
import submitit

def parse_args():
    main_parser = main_func.get_args_parser()
    parser = argparse.ArgumentParser("Submitit for InstDiffusion", parents=[main_parser])
...
def main():
    ...
    executor.update_parameters(name="instDiff")
